...
Scenario: Verificación exitosa de brigadista
    ...
    Then el sistema debe mostrar un mensaje o indicador verde de "Personal Verificado" [cite: 1100]
...
Scenario: DNI no encontrado o personal no autorizado
    ...
    Then el sistema debe mostrar una alerta roja indicando "Personal No Autorizado" [cite: 1100]